    ...
    <li class="accordion-item ls-xs mb-3">
      <h2 class="accordion-header" id="headingOne">
        <button
          ...
          <span
            class="p-1 me-2 bg-yellow fw-bolder fz-10"
          >Q1</span>
          影片拍完之後可以編輯嗎？
        </button>
      </h2>
    ...
    <li class="accordion-item ls-xs mb-3">
      <h2 class="accordion-header" id="headingTwo">
        <button
          ...
          <span 
            class="p-1 me-2 bg-yellow fw-bolder">Q2</span>
          有提供保固或維修服務嗎？
        </button>
      </h2>
      <div
    ...
    <li class="accordion-item ls-xs mb-3">
      <h2 class="accordion-header" id="headingThree">
        <button
          ...
          <span
            class="p-1 me-2 bg-yellow fw-bolder">Q3</span>
            補充包底片要去哪裡購買呢？
        </button>
      </h2>
      <div
    ...
    <li class="accordion-item ls-xs mb-3">
      <h2 class="accordion-header" id="headingFour">
        <button
          ...
          <span
            class="p-1 me-2 bg-yellow fw-bolder">Q4</span>
          印出來的拍立得照片需要充電嗎？
        </button>
      </h2>
      <div
    ...
    <li class="accordion-item ls-xs mb-3">
      <h2 class="accordion-header" id="headingFive">
        <button
          ...
          <span
            class="p-1 me-2 bg-yellow fw-bolder">Q5</span>
          運送方式及付款方式有哪些呢？
        </button>
      </h2>
      <div
    ...
    <li class="accordion-item ls-xs">
      <h2 class="accordion-header" id="headingSix">
        <button
          ...
          <span
            class="p-1 me-2 bg-yellow fw-bolder">Q6</span>
          退換貨方式及規則
        </button>
      </h2>
      <div
